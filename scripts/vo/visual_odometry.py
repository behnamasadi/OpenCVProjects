...
# poses.txt
# https://stackoverflow.com/questions/60639665/visual-odometry-kitti-dataset
...
class VisualOdometry():
    ...
    def get_matches(self, i):
        ...
        keypoints1, descriptors1 = self.orb.detectAndCompute(
            self.images[i - 1], None)
        # keypoints2 = self.orb.detect(self.images[i], None)
        keypoints2, descriptors2 = self.orb.detectAndCompute(
            self.images[i], None)
