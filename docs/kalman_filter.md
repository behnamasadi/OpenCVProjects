...
<img src="https://latex.codecogs.com/svg.latex?%5C%5C%20%5Ctext%7B1.%20%7D%20P%28A%7CB%29%3D%5Cfrac%7BP%28A%2CB%29%7D%7BP%28B%29%7D%20%5C%5C%20P%28x%29%3D%5Cint%20P%28x%2Cy%29dy%20%3D%5Cint%20P%28x%7Cy%29P%28y%29%20%5C%5C%20P%28x%29%3D%5Csum%20P%28x%2Cy_i%29%20%5C%5C%20%5Ctext%7B2.%20%7DP%28A%7CB%2CC%29%3D%5Cfrac%7BP%28A%2CB%2CC%29%7D%7BP%28B%2CC%29%7D%3D%5Cfrac%7BP%28B%7CA%2CC%29P%28A%2CC%29%7D%7BP%28B%7CC%29P%28C%29%7D%3D%5Cfrac%7BP%28B%7CA%2CC%29P%28A%7CC%29P%28C%29%7D%7BP%28B%7CC%29%7D%3D%5Cfrac%7BP%28B%7CA%2CC%29P%28A%7CC%29P%28C%29%7D%7BP%28B%7CC%29%7D" alt="https://latex.codecogs.com/svg.latex?P(A|B)=\frac{P(A,B)}{P(B)} \\ P(x)=\int P(x,y)dy =\int P(x|y)P(y) \\ P(x)=\sum P(x,y_i) \\ P(A|B,C)=\frac{P(A,B,C)} P(B,C)}=\frac{P(B|A,C)P(A,C)}{P(B|C)P(C)}=\frac{P(B|A,C)P(A|C)P(C)}{P(B|C)}=\frac{P(B|A,C)P(A|C)P(C)}{P(B|C)} " />
