...
- [2. FFmpeg Filters](docs/ffmpeg.md#2-ffmpeg-filters)
  ...
  * [2.8 Commonly Used FFmpeg Filters](docs/ffmpeg.md#28-commonly-used-ffmpeg-filters)
    + [2.8.1 format](docs/ffmpeg.md#281-format)
    + [2.8.2 split](docs/ffmpeg.md#282-split)
    + [2.8.3 scale](docs/ffmpeg.md#283-scale)
    + [2.8.4 select](docs/ffmpeg.md#284-select)
      - [Selecting Key Frames](docs/ffmpeg.md#selecting-key-frames)
      - [Extracting Scene-changing Frames](docs/ffmpeg.md#extracting-scene-changing-frames)
      - [Select Every Nth Frame](docs/ffmpeg.md#select-every-nth-frame)
    + [2.8.5 histeq](docs/ffmpeg.md#285-histeq)
    + [2.8.6 nlmeans](docs/ffmpeg.md#286-nlmeans)
    + [2.8.7 median](docs/ffmpeg.md#287-median)
    + [2.8.8 blurdetect](docs/ffmpeg.md#288-blurdetect)
    + [2.8.9 hqdn3d](docs/ffmpeg.md#289-hqdn3d)
    + [2.8.10 smooth](docs/ffmpeg.md#2810-smooth)
    + [2.8.11 convolution](docs/ffmpeg.md#2811-convolution)
    + [2.8.12 transpose](docs/ffmpeg.md#2812-transpose)
    + [2.8.13 fps](docs/ffmpeg.md#2813-fps)
    + [2.8.14 extractplanes](docs/ffmpeg.md#2814-extractplanes)
    + [2.8.15 lavfi](docs/ffmpeg.md#2815-lavfi)
- [3. ffprobe](docs/ffmpeg.md#3-ffprobe)
- [4. ffmpeg metadata](docs/ffmpeg.md#4-ffmpeg-metadata)
  * [4.1. Using ffmpeg to copy metadata](docs/ffmpeg.md#41-using-ffmpeg-to-copy-metadata)
  * [4.2. Image metadata exif](docs/ffmpeg.md#42-image-metadata-exif)
...
- [6. Set the format (container) and codec for the output](docs/ffmpeg.md#6-set-the-format--container--and-codec-for-the-output)
  * [6.1 x265 vs HEVC](docs/ffmpeg.md#61-x265-vs-hevc)
  * [6.2 codec copy](docs/ffmpeg.md#62-codec-copy)
